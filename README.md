...
Le projet P33 est une Liste complète des Meta Tags HTML
...
Utilisez des balises méta personnalisées pour stocker les données dont vous avez besoin en javascript, au lieu de coder en dur ces données dans votre javascript. Je stocke mon code Google Analytics dans des balises méta. Voici quelques exemples :
